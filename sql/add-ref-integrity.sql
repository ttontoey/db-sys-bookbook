...
ALTER TABLE markedBook ADD CONSTRAINT fk_2 FOREIGN KEY (bookId) REFERENCES book(bookId);
...
ALTER TABLE sellercontact ADD CONSTRAINT fk_1 FOREIGN KEY (userId) REFERENCES seller(userId);
